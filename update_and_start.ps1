...
Start-Process -WindowStyle Maximized powershell -ArgumentList '-noexit -command "Set-Location $pwd; Set-Location server; forever start index.js"'
Start-Process -WindowStyle Maximized powershell -ArgumentList '-noexit -command "Set-Location $pwd; Set-Location com-scanner-agent; forever start index.js"'
